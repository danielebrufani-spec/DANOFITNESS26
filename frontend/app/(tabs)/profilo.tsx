  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
              ...
              <View style={styles.notificationRow}>
                ...
                {webPushLoading ? (
                  ...
                  <Switch
                    ...
                    onValueChange={toggleWebPushNotifications}
        ...
        {/* Notifications Section - Mobile (iOS/Android) */}
        {Platform.OS !== 'web' && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Notifiche</Text>
            <View style={styles.infoCard}>
                ...
                <View style={styles.notificationInfo}>
                  ...
                  <View style={styles.infoContent}>
                    ...
                    <Text style={styles.notificationDescription}>
                      {mobileSupported 
                        ? 'Ricevi avvisi per nuovi messaggi e abbonamenti'
                        : 'Disponibile solo su dispositivi fisici'}
                    </Text>
                  </View>
                </View>
                {mobileLoading ? (
                  ...
                  <Switch
                    value={mobileSubscribed}
                    onValueChange={toggleMobileNotifications}
                    trackColor={{ false: COLORS.border, true: COLORS.primary }}
                    thumbColor="#fff"
                  />
                ) : (
