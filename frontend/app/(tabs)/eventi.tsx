...
const styles = StyleSheet.create({
  ...
  addBtnText: { fontFamily: FONTS.bodyBlack, fontSize: 16, color: '#fff', textTransform: 'uppercase', letterSpacing: 1.2 },

  emptyBox: { alignItems: 'center', paddingVertical: 40, gap: 12 },
  emptyText: { fontFamily: FONTS.body, fontSize: 16, color: COLORS.textSecondary, textAlign: 'center' },
  ...
  draftBadgeText: { fontFamily: FONTS.bodyBlack, fontSize: 12, color: '#000', letterSpacing: 1 },
  imageWrap: {
    width: '100%',
    backgroundColor: '#000',
    paddingVertical: 8,
  ...
  dateText: { fontFamily: FONTS.bodyBold, fontSize: 14, color: COLORS.primary, letterSpacing: 0.5 },
  ...
  eventText: { fontFamily: FONTS.body, fontSize: 16, color: COLORS.textSecondary, lineHeight: 21 },
  ...
  smallBtnText: { fontFamily: FONTS.bodyBold, fontSize: 13, color: '#fff', textTransform: 'uppercase' },
  ...
  label: { fontFamily: FONTS.bodyBold, fontSize: 13, color: COLORS.textSecondary, marginTop: 14, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1 },
  ...
  photoHint: { fontFamily: FONTS.body, fontSize: 14, color: COLORS.textSecondary, textAlign: 'center' },
  ...
  toggleHint: { fontFamily: FONTS.body, fontSize: 13, color: COLORS.textSecondary, marginTop: 2 },
